...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <DIV style='width: 100%;'>
    ...
    <c:set var="file1" value="${memberphVO.file1 }" />
    <c:if test="${file1.endsWith('jpg') || file1.endsWith('png') || file1.endsWith('gif')}">
      <FORM name='frm' method='POST' action='./img_delete.do' class="form-horizontal" enctype="multipart/form-data">
      <input type='hidden' name='memeberno' id='memeberno' value='1'>        
    ...
    <FORM name='frm' method='POST' action='./img_update.do' class="form-horizontal" enctype="multipart/form-data">              
      <!-- FK memberno 지정 -->
