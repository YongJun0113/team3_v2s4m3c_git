...
<img class="nature" src="publisher1.PNG" width="50%">
<img class="nature" src="publisher2.PNG" width="50%">
<img class="nature" src="publisher3.PNG" width="50%">


<p>
<button onclick="myShow.previous()">이전</button>
<button onclick="myShow.next()">다음</button>
</p>
  ...
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_create' id='frm_create' method='POST' action='./create.do'  enctype="multipart/form-data">
      ...
      <label>사진 업로드</label>  
        ...
        <input type='file' name='file1MF', id='file1MF'  value='' required="required" placeholder="파일 선택"
                  style='width: 10%;'>
        
      <label>구분번호</label>
      <input type='number' name='pub_no' value='1' required="required" 
                         min='1' max='1000' step='1' style='width: 5%;'>
        
      <label>출판사 이름</label> 
      <input type='text' name='name' value='' required="required" style='width: 31%;'><br>
       
       <label>출판사 주소</label>
      <input type='text' name='http' value='' required="required" style='width: 31%;'><br>
      
       <label>기타사항</label>
      <input type='text' name='etc' value='' required="required" style='width: 33%;'><br>
...
<TABLE class='table table-striped'>
  ...
  <c:forEach var="publisherVO" items="${list }">
    ...
    <TD class="td_bs">${publisherVO.pub_no }</TD>
     ...
     <TD class="td_bs">${publisherVO.rdate.substring(0, 10) }</TD>
     <TD class="td_bs">                                   
